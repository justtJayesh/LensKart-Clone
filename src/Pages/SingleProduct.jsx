...
import { Box, Breadcrumb, BreadcrumbItem, BreadcrumbLink, Grid, GridItem, Heading, HStack, Image, SimpleGrid, Text, Button, VStack } from '@chakra-ui/react';
...
const SingleProduct = () => {
    ...
    return (
        <Box>
            ...
            <Box p={'10px'}>
                <HStack justifyContent={'space-between'} padding={'5px 35px'}>
            ...
            <Box w={'95%'} margin={'auto'} padding={'5px'}>
                {/* <Grid templateColumns={'20% 70%'} border={'1px dashed red'}> */}
                <Box display={'flex'}>
                    <Box w={'940px'}>
                    ...
                    <Box w={'450px'} textAlign={'left'} padding={'20px'}>
                        ...
                        <Box>
                            <Button w={'390px'} colorScheme='teal' variant='solid' marginBottom={'10px'}>Buy Now</Button>
                        </Box>
