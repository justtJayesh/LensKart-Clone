import { Box, Heading, HStack, Button, Flex, Center, Image, Text } from '@chakra-ui/react';
                ...
                <Center>
                    <Box w={'1276px'} padding={'10px'}>
                        <Flex justifyContent={'space-evenly'}>
                            <Box w={'725px'}>
                                <Box p={'2px 10px'}>
                                    <Heading textAlign={'left'} as='h2' fontSize={'2xl'} fontWeight={'normal'}>Cart ({cartItem.length} items)</Heading>
                                </Box>
                                {
                                    cartItem?.map((el) => {
                            ...
                            <Box w={'360px'} h={'580px'} >
                                <Box p={'2px 10px'}>
                                    <Heading textAlign={'left'} as='h2' fontSize={'2xl'} fontWeight={'normal'}>Bill Details</Heading>
                                </Box>

                                <Box borderRadius={'12px'} border={'1px solid lightgrey'} box-shadow='rgba(99, 99, 99, 0.2) 0px 2px 8px 0px' padding={'16px'} margin={'10px'} marginBottom={'20px'} bgColor={'white'}>
                                    <HStack justifyContent={'space-between'} marginBottom={'10px'}>
                                        <Box>
                                            <Heading as='h3' fontSize={'medium'} fontWeight={'light'}>Total Price</Heading>
                                        </Box>
                                        <Box>
                                            <Heading as='h3' fontSize={'medium'} fontWeight={'light'}>Rs.{totalCartPrice}</Heading>
                                        </Box>
                                    </HStack>
